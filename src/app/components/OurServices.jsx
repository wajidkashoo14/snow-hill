...
export default function OurServices() {
  return (
    <div class="px-20 min-h-screen rounded-b-[50px] bg-[#063c49] text-center max-[600px]:px-4 max-[600px]:pb-14">
      <h1 class="font-bold py-12 text-5xl text-[#dfe4e6] opacity-55 mb-20">Our Services</h1>
      <div class="flex justify-around items-center gap-4 pt-10 max-[600px]:block max-[600px]:pt-4">
        <OurServicesCard
          image="/24-hours.png"
