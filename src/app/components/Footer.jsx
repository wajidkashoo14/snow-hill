...
export default function Footer() {
  return (
    <footer>
      ...
      <p className="text-center text-[#063c49] py-3 px-2 text-sm">2024 SnowHills Kashmir | A product of <Link className="underline" target="_blank" href="https://aqion.in/">Aqion</Link> | All rights reserved</p>
    </footer>
  );
}
